...
import { Mail, Send, CheckCircle, AlertCircle, User, Phone, MessageSquare, Building } from 'lucide-react';
...
const ContactForm: React.FC = () => {
  ...
  return (
    <section id="contact" className="py-24 bg-gradient-to-br from-slate-50 to-slate-100 scroll-mt-24">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-slate-600 text-lg max-w-2xl mx-auto">
            Completa el formulario y nuestro equipo de ingeniería se pondrá en contacto contigo a la brevedad.
          </p>
        </motion.div>
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-red-600 text-sm mt-1">
                      ...
                      <a href="mailto:ingenieria@wetechar.com" className="underline font-semibold hover:text-red-800">
                        ingenieria@wetechar.com
                      </a>
                    </p>
                    <p className="text-red-600 text-xs mt-2 italic">
                      Nota: Asegúrate de que el servidor de la API esté corriendo en el puerto 3001.
                    </p>
                  </div>
                </motion.div>
              )}
