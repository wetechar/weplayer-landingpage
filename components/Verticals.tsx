...
const Verticals: React.FC = () => {
  ...
  return (
    <section
      id='verticals'
      className='py-24 bg-slate-900 text-white overflow-hidden scroll-mt-[112px]'
    >
          ...
          <div className='lg:col-span-5'>
            ...
            <div className='space-y-4'>
              {VERTICALS.map((vertical) => (
                ...
                >
                  <h4
                    className={`text-xl font-bold mb-1 ${activeVertical.id === vertical.id ? 'text-brand-accent' : 'text-slate-300'}`}
                  >
                    {vertical.title}
                  </h4>
                ...
                <div className='absolute bottom-0 left-0 p-8 sm:p-12'>
                  ...
                  <div className='flex flex-wrap gap-3'>
                    {activeVertical.features.map((feature, idx) => (
                      <span
                        key={idx}
                        className='inline-flex items-center px-4 py-2 rounded-full bg-white/10 backdrop-blur-md border border-white/10 text-sm'
                      >
                        <CheckCircle2
                          size={16}
