...
const Services: React.FC = () => {
  return (
    ...
    >
      {/* Content Container */}
      <div
        className='relative bg-slate-100 grid grid-cols-1 grid-rows-[minmax(0,auto)_minmax(0,1fr)] 
                  ...
                  {service.imageUrl && (
                    <div className='hidden md:block absolute inset-0 z-0'>
                      ...
                      <div
                        ...
                        style={{
                          background:
                            'linear-gradient(to bottom, transparent 0%, transparent 55%, rgba(0,0,0,0.15) 60%, rgba(0,0,0,0.4) 70%, rgba(0,0,0,0.7) 100%)',
                        }}
                      />
                    </div>
                  )}
